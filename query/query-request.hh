...
public:
    enum class option {
        ...
        // When set, collection cells in the query result use an extended format that
        // embeds per-element timestamps and expiries, to support WRITETIME(col[key])
        // and TTL(col[key]) selectors.
