...
scylla_core = (['message/messaging_service.cc',
                ...
                'cql3/statements/external_search/substring_indexed_table_select_statement.cc',
                'cql3/statements/external_search/substring_pattern.cc',
